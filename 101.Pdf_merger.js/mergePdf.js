...
const pdfMerger = async (a, b) => {
    await merger.add(a);  //merge all pages. parameter is the path to file and filename.
    await merger.add(b);  //merge all pages. parameter is the path to file and filename.
